...
public class CpdetectorUtils {
    ...
    public static void main(String[] ages) {
        File filder = new File("C:\\Users\\123\\Desktop\\testuncode");
        File[] files = filder.listFiles();

        for (File file:files) {
//            System.out.println(getFileEncode(file.getPath()));
            System.out.println("文件编码: " + getFileOrIOEncode(file.getPath(), IO_ENCODE_TYPE));
        }

    }

    //获取文本编码
    public static final String FILE_ENCODE_TYPE = "file";
    //获取文件流编码
    public static final String IO_ENCODE_TYPE = "io";
    /**
     * 获取探测到的文件对象
     * 要判断文件编码格式的源文件的路径
     */
